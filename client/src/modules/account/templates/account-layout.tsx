...
const AccountLayout: React.FC<AccountLayoutProps> = async ({
  ...
  if (!customer) {
    return (
      <div
        className="flex-1 flex flex-col items-center pt-4 pb-12 small:pt-8 small:pb-16 bg-paper"
  ...
  return (
    <div
      className="flex-1 py-8 small:py-14 bg-paper"
      data-testid="account-page"
    >
      <div className="content-container max-w-6xl mx-auto">
        <div className="bg-card border border-line rounded-base shadow-card-hover p-6 small:p-10 flex flex-col gap-10">
